...
trait IERC20<TContractState>{
    fn get_property_name(self: @TContractState)-> felt252;
...
fn constructor( ref self: ContractState,
 ...
 recipient: ContractAddress
    ...
    self.property_name.write(_property_name);
 ...
 impl IERC20Impl of IERC20<ContractState>{
    fn get_property_name(self: @ContractState)-> felt252{
        self.property_name.read()
    }
